...
namespace FastFrame.Database.Migrations
{
    ...
    [Migration("20181201140757_181201.1")]
    partial class _1812011
    {
            ...
            modelBuilder.Entity("FastFrame.Entity.Basis.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "00F6P5G2VC2SAP1UJV7HTBYGA", Account = "admin", Email = "gongjie@qq.com", EncryptionKey = "df1aa8afff437e05ba53816a914c12b4", IsAdmin = true, IsDeleted = false, IsDisabled = false, IsRoot = true, Name = "超级管理员", Password = "2a5d53e47b10d00ded06f5889a8af61a", PhoneNumber = "18675517757", Tenant_Id = "00F6P5G2VC2SAP1UJV7HTBYGU" }
                    );
                });
