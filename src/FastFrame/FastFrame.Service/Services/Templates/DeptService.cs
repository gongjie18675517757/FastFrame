	...
	public partial class DeptService:BaseService<Dept, DeptDto>
	{
		...
		protected override IQueryable<DeptDto> QueryMain() 
		{
			 ...
			 var query = from _dept in deptQueryable 
						...
						join _supervisor_Id in employeeQueryable.TagWith("_supervisor_Id") on _dept.Supervisor_Id equals _supervisor_Id.Id into t__supervisor_Id
						 ...
						 select new DeptDto
						{
							...
							Supervisor=_supervisor_Id==null?null:new EmployeeDto
							{
								Id = _supervisor_Id.Id,
								EnCode = _supervisor_Id.EnCode,
								Name = _supervisor_Id.Name,
								Email = _supervisor_Id.Email,
								PhoneNumber = _supervisor_Id.PhoneNumber,
								Gender = _supervisor_Id.Gender,
								User_Id = _supervisor_Id.User_Id,
								User = null,
