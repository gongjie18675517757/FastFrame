        ...
        protected override IQueryable<DeptDto> QueryMain()
        {
            ...
            var query = from _dept in deptQueryable
                        ...
                        select new DeptDto
                        {
                            ...
                            Supervisor = _supervisor_Id == null ? null : new UserViewModel
                            {
                                Id = _supervisor_Id.Id,
                                Name = _supervisor_Id.Name,
                                Account = _supervisor_Id.Account,
                            },
                            Super = _super_Id == null ? null : new DeptViewModel
                            {
                                Id = _super_Id.Id,
                                Name = _super_Id.Name,
                                EnCode = _super_Id.EnCode,
                            },
                            Create_User = _create_User_Id == null ? null : new UserViewModel
                            {
                                Id = _create_User_Id.Id,
                                Name = _create_User_Id.Name,
                                Account = _create_User_Id.Account,
                            },
                            Modify_User = _modify_User_Id == null ? null : new UserViewModel
                            {
