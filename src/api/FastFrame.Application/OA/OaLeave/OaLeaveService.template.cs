		...
		protected override IQueryable<OaLeaveDto> DefaultQueryable() 
		{
			...
			var query = from _oaLeave in repository 
						...
						select new OaLeaveDto
						{
							...
							BeginDateTime = _oaLeave.BeginDateTime,
							EndDateTime = _oaLeave.EndDateTime,
							BeginTimeOnly = _oaLeave.BeginTimeOnly,
							EndTimeOnly = _oaLeave.EndTimeOnly,
							BeginDays = _oaLeave.BeginDays,
							EndDays = _oaLeave.EndDays,
							Days = _oaLeave.Days,
