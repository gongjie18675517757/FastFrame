...
namespace FastFrame.Database.Migrations
{
    ...
    [Migration("20190330122111_190330.2")]
    partial class _1903302
    {
            ...
            modelBuilder.Entity("FastFrame.Entity.Basis.EnumItem", b =>
                {
                    ...
                    b.HasIndex("Parent_Id")
                        .HasName("Index_EnumItem_Parent_Id");
            ...
            modelBuilder.Entity("FastFrame.Entity.Basis.RoleMember", b =>
                {
                    ...
                    b.HasIndex("Create_User_Id")
                        .HasName("Index_RoleMember_Create_User_Id");

                    b.HasIndex("Modify_User_Id")
                        .HasName("Index_RoleMember_Modify_User_Id");

                    b.HasIndex("Role_Id")
                        .HasName("Index_RoleMember_Role_Id");

                    b.HasIndex("Tenant_Id")
                        .HasName("Index_RoleMember_Tenant_Id");
            ...
            modelBuilder.Entity("FastFrame.Entity.Basis.RolePermission", b =>
                {
                    ...
                    b.HasIndex("Create_User_Id")
                        .HasName("Index_RolePermission_Create_User_Id");

                    b.HasIndex("Modify_User_Id")
                        .HasName("Index_RolePermission_Modify_User_Id");
                    ...
                    b.HasIndex("Tenant_Id")
                        .HasName("Index_RolePermission_Tenant_Id");
