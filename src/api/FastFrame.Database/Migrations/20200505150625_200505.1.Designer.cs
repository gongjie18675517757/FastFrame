...
namespace FastFrame.Database.Migrations
{
    ...
    [Migration("20200505150625_200505.1")]
    partial class _2005051
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FastFrame.Entity.Basis.ReourceMap", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnName("id")
                        .HasColumnType("varchar(25) CHARACTER SET utf8mb4")
                    ...
                    b.HasIndex("FKey_Id")
                        .HasName("Index_ReourceMap_FKey_Id");

                    b.HasIndex("File_Id")
                        .HasName("Index_ReourceMap_File_Id");

                    b.ToTable("basis_reourcemap");
                });
            ...
            modelBuilder.Entity("FastFrame.Entity.Basis.RolePermission", b =>
                {
                    ...
                    b.Property<string>("SuperPermissionKey")
                        .HasColumnName("superpermissionkey")
                        .HasColumnType("varchar(100) CHARACTER SET utf8mb4")
                        .HasMaxLength(100)
                        .IsUnicode(true);
            ...
            modelBuilder.Entity("FastFrame.Entity.Flow.FlowInstanceDept", b =>
                {
                    ...
                    b.HasIndex("BeDept_Id")
                        .HasName("Index_FlowInstanceDept_BeDept_Id");

                    b.HasIndex("FlowInstance_Id")
                        .HasName("Index_FlowInstanceDept_FlowInstance_Id");

                    b.HasIndex("isdeleted")
                        .HasName("Index_FlowInstanceDept_isdeleted");

                    b.HasIndex("tenant_id")
                        .HasName("Index_FlowInstanceDept_tenant_id");
            ...
            modelBuilder.Entity("FastFrame.Entity.OA.OaLeave", b =>
                {
                    ...
                    b.HasIndex("Agent_Id")
                        .HasName("Index_OaLeave_Agent_Id");

                    b.HasIndex("Create_User_Id")
                        .HasName("Index_OaLeave_Create_User_Id");

                    b.HasIndex("Dept_Id")
                        .HasName("Index_OaLeave_Dept_Id");

                    b.HasIndex("Job_Id")
                        .HasName("Index_OaLeave_Job_Id");

                    b.HasIndex("Modify_User_Id")
                        .HasName("Index_OaLeave_Modify_User_Id");

                    b.HasIndex("isdeleted")
                        .HasName("Index_OaLeave_isdeleted");

                    b.HasIndex("tenant_id")
                        .HasName("Index_OaLeave_tenant_id");
