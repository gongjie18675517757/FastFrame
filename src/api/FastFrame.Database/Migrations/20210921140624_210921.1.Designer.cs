...
namespace FastFrame.Database.Migrations
{
    ...
    [Migration("20210921140624_210921.1")]
    partial class _2109211
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FastFrame.Entity.Flow.FlowNodeChecker", b =>
                {
                    ...
                    b.ToTable("flow_flownodechecker");

                    b
                        .HasComment("流程节点审核人/抄送人");
                });
            ...
            modelBuilder.Entity("FastFrame.Entity.Flow.FlowProcessNextChecker", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(25)
                        .IsUnicode(true)
                    ...
                    b.Property<string>("FlowProcess_Id")
                        .HasMaxLength(25)
                        .IsUnicode(true)
                        .HasColumnType("varchar(25)")
                        .HasColumnName("flowprocess_id")
                        .HasComment("关联:FlowProcess");

                    b.HasKey("Id");

                    b.HasIndex("Checker_Id")
                        .HasDatabaseName("Index_FlowProcessNextChecker_Checker_Id");

                    b.HasIndex("FlowProcess_Id")
                        .HasDatabaseName("Index_FlowProcessNextChecker_FlowProcess_Id");

                    b.ToTable("flow_flowprocessnextchecker");

                    b
                        .HasComment("指定的下一步审核人");
                });
            ...
            modelBuilder.Entity("FastFrame.Entity.Flow.FlowStepUser", b =>
                {
                    ...
                    b.HasIndex("FlowNode_Id")
                        .HasDatabaseName("Index_FlowStepUser_FlowNode_Id");
